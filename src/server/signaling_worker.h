...
private:
    ...
    int _process_pull(int cmdno, TcpConnection* c, const json& root, uint32_t log_id);
    ...
    int _process_stop_pull(int cmdno, TcpConnection* c, const json& root, uint32_t log_id);
